...
?>
		...
		/*	print "Screened  {$screen} <br/>";
			...
			/*, collect={$collect}, process={$process}, a={$_POST['a']}, b={$_POST['b']}, c={$_POST['c']}, alpha={$_POST['alpha']}, beta={$_POST['beta']}, gamma={$_POST['gamma']}, resolution={$_POST['res']}, space_group="{$_POST['sg']}", beamline="{$_POST['beamline']}", detector="{$_POST['detector']}", completeness={$_POST['completeness']}, reflections={$_POST['reflections']}, time={$_POST['time']}, c_notes={$_POST['c_notes']} */
			$query = "UPDATE sample SET screen={$screen}, collect={$collect}, process={$process}, a=\"{$_POST['a']}\", b=\"{$_POST['b']}\", c=\"{$_POST['c']}\", alpha=\"{$_POST['alpha']}\", beta=\"{$_POST['beta']}\", gamma=\"{$_POST['gamma']}\",resolution=\"{$_POST['res']}\", space_group=\"{$_POST['sg']}\", beamline=\"{$_POST['beamline']}\", detector=\"{$_POST['detector']}\", completeness=\"{$_POST['completeness']}\", reflections=\"{$_POST['reflections']}\", time=\"{$_POST['time']}\", c_notes=\"{$_POST['c_notes']}\" WHERE sample_ID={$_POST['sample']}";
...
<?php } 
			...
			<tr>
				...
				<td>
						...
						<b>Screened:</b> <INPUT TYPE=CHECKBOX name="screen"><br/>
						<b>Collected:</b> <INPUT TYPE=CHECKBOX name="collect"><br/>
						<b>Processed:</b> <INPUT TYPE=CHECKBOX name="process">
				</tr>
				<tr>
					<td>Collection Notes: </td>
					<td><textarea name="c_notes" cols="50" rows="5">Details</textarea></td>
				</tr>
				<tr>
                    <td>Crystal Information: </td>
					<td>a <input type="text" size="7" maxlength="7" name="a" value="" /> alpha &nbsp;&nbsp;&nbsp;<input type="text" size="7" maxlength="7" name="alpha" value="" /></td>
					<tr><td /><td>b <input type="text" size="7" maxlength="7" name="b" value="" /> beta&nbsp;&nbsp;&nbsp;&nbsp; <input type="text" size="7" maxlength="7" name="beta" value="" /></td></tr>
					<tr><td /><td>c <input type="text" size="7" maxlength="7" name="c" value="" /> gamma <input type="text" size="7" maxlength="7" name="gamma" value="" /></td></tr>
					<tr><td /><td>Resolution <input type="text" size="7" maxlength="7" name="res" value="" /> Space Group <input type="text" size="15" maxlength="15" name="sg" value="" /></td></tr>
				</tr>
				<tr>
					<td>Other: </td>
					<td>Detector <input type="text" size="7" maxlength="7" name="detector" value="" /> Beamline &nbsp;&nbsp;&nbsp;<input type="text" size="7" maxlength="7" name="beamline" value="" /></td>
					<tr><td /><td>Completeness <input type="text" size="7" maxlength="7" name="completeness" value="" /> Reflections&nbsp;&nbsp;&nbsp;&nbsp; <input type="text" size="7" maxlength="7" name="reflections" value="" /></td></tr>
					<tr><td /><td>Exposure Time <input type="text" size="7" maxlength="7" name="time" value="" /></td></tr>
				</tr>
			</table>
			<br />
				<p align="center"><input type="image" src="images/check.gif" name="Add Sample" /></p>
...
else if($valid==3) print "Sample updated successfully.";
