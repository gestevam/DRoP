...
print "<ul>";
	...
	if(mysql_num_rows($results) > 0) 
	{
		...
		while($resultsArray = mysql_fetch_array($results)) 
		{
			...
			{
				print "<font color=red>Run has failed. Error 222: Missing CRYST1 line.</font>";
			}
			...
			if ($resultsArray['run_status']==777)
			{
				...
				print "Click <a href=\"autosave.php?run={$resultsArray['data_ID']}\">Here</a> for your results.";
