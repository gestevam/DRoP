...
<body>
	...
	<div id="wrapper">
		<div id="logo" class="clearfix">
			...
			<img src="images/logo2.gif" width="581" height="93" alt="Crystallography Database" class="nameimg" />
		</div>
		<div id="bar">
<?php
...
?>
	...
	$results = mysql_query("SELECT Name, Email FROM Client WHERE Client_ID != 0", $link);
